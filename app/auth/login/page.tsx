...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#FDE500] px-6">
      <form onSubmit={handleLogin} className="bg-white rounded-xl shadow-md p-8 w-full max-w-sm flex flex-col gap-4">
        <h1 className="text-3xl font-black text-black mb-2 text-center">Login</h1>
        <input
          type="email"
          placeholder="Email"
          value={email}
        ...
        <div className="text-center text-sm mt-2">
          ...
          <Link href="/auth/signup" className="text-black font-bold underline">Sign up</Link>
        </div>
      </form>
    </div>
  );
